...
export const expandedRecipes: AnalyzeImageResponse[] = [
  ...
  },
  {
    ...
    description: "A classic French soup featuring caramelized onions in a rich beef broth, topped with crusty bread and melted Gruyère cheese. Dating back to 18th century France, this comforting dish was originally a peasant food that has evolved into a beloved restaurant staple known for its deep, complex flavors and gratinéed cheese topping.",
    tags: ["French", "Soup", "Comfort Food", "Winter", "Cheese"],
    youtubeVideos: frenchYoutubeVideos,
    recipes: [
      {
        title: "Classic French Onion Soup",
        description: "This timeless French soup features slowly caramelized onions in a rich, savory broth, topped with crusty bread and a blanket of melted Gruyère cheese. The long, slow cooking process develops deep flavor, making this simple soup extraordinarily delicious.",
        prepTime: "15 minutes",
        ...
        difficulty: "Intermediate",
        tags: ["French", "Classical", "Vegetarian option"],
        ingredients: [
          ...
          "8 cups beef stock (or vegetable stock for vegetarian option)",
          "2 bay leaves",
        ...
        instructions: [
          ...
          "Add the sliced onions and toss to coat with the butter mixture. Cover and cook for about 15 minutes to soften.",
          "Uncover, add sugar and a pinch of salt, and increase heat to medium-high. Cook for 30-40 minutes, stirring frequently, until onions are deeply caramelized and a rich golden brown.",
          "Sprinkle flour over the onions and cook, stirring, for 2-3 minutes.",
          "Add the wine and use a wooden spoon to scrape up any browned bits from the bottom of the pot.",
          "Add the stock, bay leaves, and thyme. Bring to a simmer, then reduce heat to low and cook, partially covered, for 30 minutes.",
          "Meanwhile, preheat the broiler. Place the baguette slices on a baking sheet and toast under the broiler until golden on both sides, about 1-2 minutes per side.",
          "Remove the bay leaves and thyme sprigs from the soup. Stir in the cognac if using, and season with salt and pepper to taste.",
          "Ladle the soup into oven-safe bowls placed on a baking sheet. Float 1-2 toasted baguette slices on top of each bowl of soup.",
          "Sprinkle the grated Gruyère cheese generously over the bread and soup, allowing some to hang over the edges of the bowl.",
          ...
          "Carefully remove from the broiler (the bowls will be very hot) and serve immediately."
        ],
        chefTips: [
          "The secret to great French onion soup is patience with the onions - proper caramelization can take 45 minutes or more",
          "Use a mix of onion varieties (yellow, sweet, red) for more complex flavor",
          "For vegetarian version, use a rich mushroom stock instead of beef stock",
          "The cognac is optional but adds wonderful depth to the finished soup"
        ],
        commonMistakes: [
          "Rushing the caramelization process, which prevents developing deep flavor",
          "Using too much liquid, which dilutes the rich onion flavor",
          "Not using enough cheese or broiling properly for the signature crust",
          "Slicing onions too thickly, which prevents them from cooking down properly"
        ],
        nutritionInfo: {
          calories: 420,
          protein: "18g",
          ...
          healthyAlternatives: [
            "Use less cheese and more broth for a lighter version",
            "Substitute whole grain bread for the baguette for more fiber",
            "Use low-sodium broth to reduce salt content"
          ],
          dietaryNotes: [
            "High in calcium from the Gruyère cheese",
            "Contains allicin from onions, which has anti-inflammatory properties",
            "Can be adapted for vegetarians by using vegetable stock"
          ]
        },
        variations: [
          {
            type: "rustic",
            description: "A heartier version with additional ingredients",
            adjustments: [
              "Add 1 cup of sliced mushrooms when caramelizing the onions",
              "Include 2 cloves of minced garlic in the final 5 minutes of onion caramelization",
              "Use a robust red wine instead of white wine"
            ]
          },
          {
            type: "modern",
            description: "A contemporary take with creative twists",
            adjustments: [
              "Add a tablespoon of balsamic vinegar for depth and slight sweetness",
              "Use a combination of Gruyère and blue cheese for a more complex flavor",
              "Garnish with fresh chives and a drizzle of truffle oil before serving"
            ]
          }
        ],
        sideDishSuggestions: [
          {
            ...
            description: "Mixed greens with a light Dijon vinaigrette",
            preparationTime: "10 minutes",
            pairingReason: "The light, tangy salad balances the rich, savory soup"
          },
          {
            name: "Roasted Garlic Bread",
            description: "Crusty bread with roasted garlic butter",
            preparationTime: "15 minutes",
            pairingReason: "Additional bread for sopping up every last bit of the delicious broth"
          }
        ],
        storageInstructions: "Store the soup (without bread and cheese topping) in an airtight container in the refrigerator for up to 3 days. The flavor often improves after a day.",
        reheatingMethods: "Reheat the soup on the stovetop over medium heat until hot. Add the bread and cheese topping just before serving, and broil as directed in the recipe.",
        beveragePairings: [
          "Dry Alsatian white wine such as Pinot Blanc or Riesling",
          "Light-bodied red wine like Beaujolais",
          "French cider (cidre) for a traditional pairing"
        ]
      }
    ]
  },
  ...
  {
    foodName: "Greek Tzatziki",
    description: "A refreshing Greek yogurt dip or sauce made with cucumber, garlic, olive oil, and herbs. This versatile Mediterranean condiment has ancient origins and is essential to Greek cuisine, serving as a cooling complement to grilled meats, a dip for bread and vegetables, or a topping for gyros and souvlaki.",
    tags: ["Greek", "Mediterranean", "Dip", "Yogurt", "Cold"],
    youtubeVideos: mediterraneanYoutubeVideos,
    recipes: [
      {
        title: "Authentic Greek Tzatziki",
        description: "This classic Greek yogurt and cucumber dip features the perfect balance of creamy yogurt, cool cucumber, pungent garlic, and bright herbs. The secret to great tzatziki is properly draining both the yogurt and cucumber to achieve the ideal thick, creamy texture.",
        prepTime: "20 minutes (plus 2 hours draining time)",
        cookTime: "0 minutes",
        totalTime: "2 hours 20 minutes",
        servings: 8,
        servingSize: "1/4 cup",
        difficulty: "Easy",
        tags: ["Greek", "Mediterranean", "Vegetarian", "Gluten-free"],
        ingredients: [
  ...
  },
  {
    ...
    description: "Brazil's national dish, a hearty black bean stew with various cuts of pork and beef, simmered for hours until rich and flavorful. Originating during the colonial period, this weekend celebration dish evolved from slave food to national treasure and is traditionally served with rice, collard greens, orange slices, and farofa (toasted cassava flour).",
    tags: ["Brazilian", "Stew", "Beans", "Pork", "Celebration"],
    youtubeVideos: brazilianYoutubeVideos,
    recipes: [
      {
        title: "Traditional Brazilian Feijoada",
        description: "This rich black bean stew is Brazil's national dish, featuring various cuts of pork and beef slow-cooked with black beans until tender and flavorful. Traditionally served on Saturdays as a celebratory meal, complete feijoada is a feast with rice, collard greens, orange slices, hot sauce, and farofa.",
        prepTime: "12 hours (including soaking)",
        cookTime: "3 hours",
        totalTime: "15 hours",
        servings: 8,
        servingSize: "1.5 cups stew plus accompaniments",
        difficulty: "Advanced",
        tags: ["Brazilian", "Stew", "Weekend project", "Traditional"],
        ingredients: [
          "For the feijoada:",
          "1 pound (450g) dried black beans, soaked overnight",
          "1/2 pound (225g) carne seca or salt beef (or substitute corned beef), soaked overnight if necessary",
          "1/2 pound (225g) pork shoulder, cubed",
          "1/2 pound (225g) pork ribs, cut into individual ribs",
          "2 smoked pork sausages (like linguiça or kielbasa), sliced",
          "1/4 pound (115g) smoked bacon, diced",
          "1 smoked ham hock",
          "2 bay leaves",
          ...
          "Hot sauce (malagueta sauce or similar)",
          "Fresh parsley for garnish"
        ],
        instructions: [
          "Soak the beans and salt beef (if using) separately in water overnight.",
          "Drain and rinse the beans. Place them in a large pot with fresh water, bay leaves, and the ham hock. Bring to a boil, then reduce heat and simmer, partially covered, for about 1 hour.",
          "Meanwhile, heat olive oil in a large skillet over medium heat. Add the bacon and cook until it begins to render its fat.",
          "Add the onions and garlic to the skillet and sauté until softened, about 5 minutes.",
          "Add the cubed pork shoulder and ribs to the skillet and brown on all sides, about 7-10 minutes.",
          "Transfer the contents of the skillet to the bean pot. Add the sausages and drained salt beef or corned beef.",
          "Continue to simmer, partially covered, for about 2 more hours, stirring occasionally and adding water if needed to keep the beans submerged, until all meats are tender and the beans have created a thick, rich broth.",
          "Season with cumin, salt, and pepper to taste.",
          "While the feijoada is finishing, prepare the accompaniments:",
          "For the collard greens: Heat olive oil in a large skillet, add minced garlic and sauté until fragrant. Add the thinly sliced collard greens and cook, stirring, until wilted but still bright green, about 3-5 minutes. Season with salt.",
          "Warm the farofa in a dry skillet if desired.",
          "To serve: Ladle the feijoada into bowls, making sure each serving has a variety of meats. Serve with white rice, collard greens, orange slices, farofa, and hot sauce on the side.",
          "Garnish with fresh parsley and an extra drizzle of olive oil if desired."
        ],
        chefTips: [
          "Authentic feijoada uses a variety of pork cuts, including ears, feet, and tail - adjust based on availability and preference",
          "The stew tastes even better the next day after flavors have melded, so consider making it a day ahead",
          "Don't skip the orange slices - the acidity and sweetness are essential to balance the rich, heavy stew",
          "Traditional farofa is made by toasting cassava flour in butter with onions and garlic - look for it in Latin American markets or make your own"
        ],
        commonMistakes: [
          "Not soaking the beans, which results in longer cooking time and potentially tough beans",
          "Rushing the cooking process - feijoada needs slow, long cooking to develop its flavors",
          "Omitting key accompaniments like orange slices and farofa, which are integral to the complete experience",
          "Adding too much salt early in the cooking process, especially if using salted meats"
        ],
        nutritionInfo: {
          calories: 780,
          protein: "42g",
          ...
          healthyAlternatives: [
            "Use turkey sausage instead of pork sausage for less fat",
            "Reduce the amount of meat and increase beans for a lighter version",
            "Use brown rice instead of white for more fiber"
          ],
          dietaryNotes: [
            "High in protein and iron from the beans and meat",
            "Rich in fiber from beans and collard greens",
            "Vitamin C from the oranges helps with iron absorption from the beans"
          ]
        },
        variations: [
          {
            type: "weeknight",
            description: "A simplified version for busy days",
            adjustments: [
              "Use canned black beans instead of dried (about 3 cans, drained and rinsed)",
              "Limit meat selection to just pork shoulder and sausage",
              "Use a pressure cooker or Instant Pot to reduce cooking time to about 45 minutes"
            ]
          },
          {
            type: "regional",
            description: "A Rio de Janeiro style variation",
            adjustments: [
              "Add dried beef (carne seca) soaked overnight and diced",
              "Include orange peels during cooking for subtle citrus flavor",
              "Serve with a sprinkle of toasted manioc flour mixed with hard-boiled eggs"
            ]
          }
        ],
        sideDishSuggestions: [
          {
            ...
            preparationTime: "10 minutes",
            pairingReason: "The sweetness complements the savory stew"
          },
          {
            name: "Brazilian Cheese Bread (Pão de Queijo)",
            description: "Small, round, cheese-flavored rolls made with tapioca flour",
            preparationTime: "30 minutes",
            pairingReason: "A traditional Brazilian side that pairs well with the meal"
          }
        ],
        storageInstructions: "Store in an airtight container in the refrigerator for up to 3 days or freeze for up to 3 months. The flavor often improves over time.",
        reheatingMethods: "Reheat gently on the stovetop over medium-low heat, adding a little water if needed to reach desired consistency. Alternatively, microwave with a splash of water, stirring halfway through.",
        beveragePairings: [
          "Caipirinha - Brazil's national cocktail made with cachaça, lime, and sugar",
          "Brazilian lager beer such as Brahma or Antarctica",
          "Fresh lime juice mixed with sparkling water for a non-alcoholic option"
        ]
      }
    ]
  },
  {
    foodName: "Falafel",
    description: "A Middle Eastern deep-fried patty or ball made from ground chickpeas or fava beans, seasoned with herbs and spices. With origins dating back thousands of years to Egypt, falafel has become a popular street food throughout the Middle East and globally, known for its crispy exterior, tender interior, and aromatic herb-packed flavor.",
    tags: ["Middle Eastern", "Vegetarian", "Chickpeas", "Fried", "Street Food"],
    youtubeVideos: middleEasternYoutubeVideos,
    recipes: [
      {
        title: "Authentic Middle Eastern Falafel",
        description: "These crispy chickpea fritters are a staple of Middle Eastern cuisine, featuring a perfectly spiced herb-green interior and crunchy exterior. Made with dried (not canned) chickpeas soaked overnight and ground with fresh herbs and spices, these falafel have an authentic texture and bright flavor that make them ideal for stuffing in pita or adding to mezze platters.",
        prepTime: "12 hours (including soaking)",
        cookTime: "30 minutes",
        totalTime: "12 hours 30 minutes",
        servings: 6,
        servingSize: "4 falafel (about 20-24 total)",
        difficulty: "Intermediate",
        ...
        ingredients: [
          ...
          "3-4 tablespoons all-purpose flour or chickpea flour",
        ...
        instructions: [
          "Place the dried chickpeas in a large bowl and cover with cold water by at least 3 inches. Soak for 12-24 hours in the refrigerator. They will double in size.",
          "Drain the soaked chickpeas thoroughly and pat dry with paper towels.",
          "In a food processor, combine the chickpeas, onion, garlic, parsley, and cilantro. Pulse until finely minced but not pureed – the texture should be like coarse sand, not a smooth paste.",
          "Transfer the mixture to a large bowl and add the cumin, coriander, salt, pepper, cardamom, and cayenne (if using). Mix well to distribute the spices evenly.",
          "Cover the bowl and refrigerate for at least 1 hour or up to overnight to allow the flavors to meld.",
          "When ready to cook, add baking powder and flour to the mixture and mix well. The mixture should hold together when squeezed but still be somewhat loose.",
          "Heat oil in a deep fryer or deep heavy-bottomed pot to 350°F (175°C).",
          "While the oil is heating, form the falafel mixture into small balls or patties about 1 1/2 inches in diameter. If the mixture doesn't hold together, add a bit more flour.",
          "Carefully drop the falafel balls into the hot oil, working in batches to avoid overcrowding. Fry for 3-4 minutes until deeply golden brown and crispy on the outside.",
          "Remove with a slotted spoon and drain on paper towels. Repeat with the remaining falafel mixture.",
          "Serve hot in pita bread with tahini sauce, cucumber-tomato salad, pickled turnips, and hot sauce if desired."
        ],
        chefTips: [
          "Never use canned chickpeas for authentic falafel - they're too soft and wet, resulting in mushy fritters that fall apart",
          "The falafel mixture can be made up to 2 days ahead and refrigerated, making assembly quicker when ready to cook",
          "If you prefer baking, arrange falafel on a parchment-lined baking sheet, brush with oil, and bake at 375°F (190°C) for 25-30 minutes, flipping halfway through",
          "Use a falafel scoop or ice cream scoop for uniformly sized falafel that cook evenly"
        ],
        commonMistakes: [
          "Using canned chickpeas instead of dried and soaked chickpeas",
          "Over-processing the mixture into a smooth paste, which makes dense falafel",
          "Not letting the mixture rest, which helps the flavors develop and ingredients bind",
          "Frying at too low a temperature, which makes the falafel absorb too much oil and become greasy"
        ],
        nutritionInfo: {
          calories: 320,
          protein: "15g",
          ...
          healthyAlternatives: [
            ...
            "Use a air fryer for a similar crispy texture with much less oil",
            "Add more fresh herbs and reduce salt for a lower-sodium option"
          ],
          dietaryNotes: [
            "Excellent source of plant-based protein",
            "High in fiber from chickpeas",
            "Naturally vegan and can be made gluten-free by using chickpea flour"
          ]
        },
        variations: [
          {
            type: "Egyptian",
            description: "Traditional Egyptian style made with fava beans",
            adjustments: [
              "Substitute dried fava beans (soaked overnight) for the chickpeas",
              "Add 2 tablespoons fresh dill to the herb mixture",
              "Include 1 teaspoon ground cinnamon with the other spices"
            ]
          },
          {
            type: "spicy",
            ...
            adjustments: [
              ...
              "Add 1-2 finely chopped jalapeños to the mixture",
              "Include 1 teaspoon hot paprika with the spices"
            ]
          }
        ],
        sideDishSuggestions: [
          {
            ...
            description: "Fresh herb and bulgur salad with tomatoes, cucumbers, and lemon dressing",
            preparationTime: "20 minutes (plus soaking time for bulgur)",
            pairingReason: "The bright, fresh flavors balance the rich, hearty falafel"
          },
          {
            name: "Baba Ganoush",
            description: "Smoky eggplant dip with tahini, garlic, and lemon",
            preparationTime: "45 minutes",
            pairingReason: "A traditional mezze that complements the flavors of falafel"
          },
          {
            name: "Pickled Turnips",
            description: "Crunchy, bright pink pickled turnips - a traditional accompaniment",
            preparationTime: "15 minutes (plus several days pickling time)",
            pairingReason: "The tangy, crunchy pickles cut through the richness of fried falafel"
          }
        ],
        storageInstructions: "The uncooked falafel mixture can be refrigerated for up to 2 days. Cooked falafel can be stored in an airtight container in the refrigerator for up to 3 days.",
        reheatingMethods: "Reheat in a 350°F (175°C) oven for 10-15 minutes until warmed through and crispy again. Avoid microwaving, which makes them soggy.",
        beveragePairings: [
          "Mint tea - traditional Middle Eastern pairing, served hot or cold",
          "Arak or Ouzo - anise-flavored spirits traditional to the region",
          "Lemonade with mint - refreshing complement to the spiced falafel"
        ]
      }
    ]
  },
