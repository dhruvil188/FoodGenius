...
export const expandedRecipes: AnalyzeImageResponse[] = [
  ...
  },
  {
    ...
    description: "A traditional Vietnamese noodle soup consisting of bone broth, rice noodles, herbs, and meat (usually beef). This iconic dish dates back to the early 20th century in northern Vietnam and has gained worldwide popularity for its aromatic broth, complex flavors, and customizable garnishes.",
    tags: ["Vietnamese", "Soup", "Noodles", "Aromatic", "Comfort Food"],
    youtubeVideos: genericYoutubeVideos,
    recipes: [
      {
        title: "Authentic Vietnamese Beef Pho",
        description: "This beloved Vietnamese soup features a deeply flavored broth infused with star anise, cinnamon, and other aromatics, served with tender rice noodles, thinly sliced beef, and fresh herbs. The result is a harmonious balance of savory, sweet, and umami flavors that has made pho an international favorite.",
        prepTime: "30 minutes",
        cookTime: "3 hours",
        ...
        servingSize: "2 cups",
        difficulty: "Intermediate",
        tags: ["Vietnamese", "Traditional", "Soup", "Beef"],
        ingredients: [
  ...
  {
    foodName: "Indian Butter Chicken",
    description: "A rich, creamy North Indian curry dish made with tender chicken in a tomato, butter, and cream sauce. Originating in Delhi in the 1950s, this beloved dish (also known as Murgh Makhani) is known for its velvety texture and mild, slightly sweet flavor profile that has made it one of the most popular Indian dishes globally.",
    tags: ["Indian", "Curry", "Chicken", "Creamy", "Comfort Food"],
    youtubeVideos: genericYoutubeVideos,
    recipes: [
      {
        title: "Restaurant-Style Butter Chicken",
        description: "This beloved North Indian dish features tender chicken pieces marinated in yogurt and spices, then simmered in a rich, creamy tomato and butter sauce. Known for its velvety texture and balanced spices, this butter chicken (murgh makhani) recipe delivers restaurant-quality flavor at home.",
        prepTime: "30 minutes (plus 4 hours marinating)",
        cookTime: "45 minutes",
        totalTime: "5 hours 15 minutes",
        servings: 6,
        servingSize: "1 cup curry with rice",
        difficulty: "Intermediate",
  ...
  {
    foodName: "Mexican Enchiladas",
    description: "Traditional Mexican dish consisting of corn tortillas rolled around a filling and covered with a savory sauce. Dating back to Mayan times, enchiladas have evolved over centuries and are now a cornerstone of Mexican cuisine, featuring numerous regional variations with different fillings, sauces, and toppings across Mexico.",
    tags: ["Mexican", "Corn Tortillas", "Cheese", "Spicy", "Comfort Food"],
    youtubeVideos: mexicanYoutubeVideos,
    recipes: [
      {
        title: "Authentic Mexican Enchiladas Rojas",
        description: "These classic Mexican enchiladas feature corn tortillas dipped in a rich, smoky red chile sauce, filled with cheese or chicken, then topped with crema, queso fresco, and onions. This traditional dish delivers the perfect balance of flavors and textures - soft tortillas, flavorful filling, and a complex sauce with just the right level of heat.",
        prepTime: "40 minutes",
        cookTime: "30 minutes",
        totalTime: "1 hour 10 minutes",
        servings: 6,
        servingSize: "2 enchiladas per person",
        difficulty: "Intermediate",
        tags: ["Mexican", "Traditional", "Comfort Food", "Spicy"],
        ingredients: [
